...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS",
    default="localhost,127.0.0.1,api.nadlaner.com,app.nadlaner.com,nadlaner-api-460859266427.me-west1.run.app,34.8.12.175",
).split(",")
...
if os.getenv("USE_CELERY", "false").lower() == "true":
    ...
    CELERY_BEAT_SCHEDULE = {
        ...
        # Analytics rollup disabled - using Vercel Analytics and Google Analytics instead
        # 'rollup-analytics': {
...
GOOGLE_CLIENT_ID = config(
    "GOOGLE_CLIENT_ID", default="your-google-client-id.apps.googleusercontent.com"
)
GOOGLE_CLIENT_SECRET = config(
    "GOOGLE_CLIENT_SECRET", default="your-google-client-secret"
)
...
EMAIL_FALLBACK_TO_CONSOLE = config(
    "EMAIL_FALLBACK_TO_CONSOLE", default=False, cast=bool
)
