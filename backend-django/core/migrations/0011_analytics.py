    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["created_at"], name="core_analy_created_1a634f_idx"
                    ),
                    models.Index(fields=["event"], name="core_analy_event_8d3b50_idx"),
                    models.Index(
                        fields=["source"], name="core_analy_source_12d921_idx"
                    ),
                    models.Index(
                        fields=["error_code"], name="core_analy_error_c_1b9f5f_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(fields=["date"], name="core_analy_date_4b2427_idx")
                ],
            },
        ),
    ]
