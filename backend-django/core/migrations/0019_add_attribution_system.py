            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="core_userpr_reputat_4acfb8_idx",
                    ),
                    models.Index(
                        fields=["assets_created"], name="core_userpr_assets__4e5d07_idx"
                    ),
                    models.Index(
                        fields=["last_contribution_at"],
                        name="core_userpr_last_co_6f7bfa_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "new_value",
                    models.TextField(
                        blank=True, help_text="New value added or updated", null=True
                    ),
                ),
                (
                    "source",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["asset", "user"], name="core_assetc_asset_i_69deea_idx"
                    ),
                    models.Index(
                        fields=["contribution_type"],
                        name="core_assetc_contrib_68529f_idx",
                    ),
                    models.Index(
                        fields=["created_at"], name="core_assetc_created_e35010_idx"
                    ),
                ],
            },
        ),
