    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file_path",
                    models.CharField(help_text="Path to stored file", max_length=500),
                ),
                ...
                (
                    "external_url",
                    models.URLField(
                        blank=True, help_text="URL to external document", null=True
                    ),
                ),
                (
                    "source",
        ...
        migrations.AddIndex(
            model_name="document",
            index=models.Index(
                fields=["document_type"], name="core_docume_documen_5649ee_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="document",
        ...
        migrations.AddIndex(
            model_name="document",
            index=models.Index(
                fields=["uploaded_at"], name="core_docume_uploade_e13ffd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="document",
            index=models.Index(
                fields=["external_id"], name="core_docume_externa_0b9c72_idx"
            ),
        ),
    ]
