...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('core', '0055_rename_core_apitok_token_idx_core_apitok_token_8d7878_idx_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_challenge', models.CharField(blank=True, max_length=128, null=True)),
                ('code_challenge_method', models.CharField(default='plain', max_length=10)),
        ...
        migrations.AddIndex(
            model_name='oauthauthorizationcode',
            index=models.Index(fields=['client_id', 'used'], name='core_oauth_client_used_idx'),
        ),
    ]
