...
class Migration(migrations.Migration):
    dependencies = [
        ...
        (
            "core",
            "0063_rename_core_apitok_token_idx_core_apitok_token_8d7878_idx_and_more",
        ),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Number of questions asked in the current period",
                    ),
                ),
                (
                    "last_reset_at",
        ...
        migrations.AddIndex(
            model_name="agentchatusage",
            index=models.Index(
                fields=["questions_count"], name="core_agentc_questio_idx"
            ),
        ),
    ]
