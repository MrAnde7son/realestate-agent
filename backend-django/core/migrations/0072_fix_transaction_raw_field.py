...
def fix_raw_field_data(apps, schema_editor):
    ...
    if fixed_count > 0:
        print(f"Fixed {fixed_count} RealEstateTransaction records with invalid raw field format")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0071_rename_core_asset_permit__0fa22a_idx_core_asset_total_p_41022b_idx_and_more'),
    ]
