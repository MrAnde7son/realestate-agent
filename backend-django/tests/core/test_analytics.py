...
def create_test_events():
    ...
    track_feature_usage(
        ...
        user=user,
        asset_id=1,
        meta={"filter_type": "city", "value": "tel_aviv"},
    )
    track_feature_usage(
        "filter",
        user=user,
        asset_id=1,
        meta={"filter_type": "price_min", "value": 1000000},
    )
    track_feature_usage(
        "export", user=user, asset_id=1, meta={"export_type": "csv", "asset_count": 1}
    )
    track_feature_usage(
        "marketing_message",
        user=user,
        asset_id=1,
        meta={"message_type": "share_message", "language": "he"},
    )
