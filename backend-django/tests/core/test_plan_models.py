...
class TestPlanTypeModel:
    ...
    def test_plan_type_defaults(self):
        ...
        plan_type = PlanType.objects.create(name="test", display_name="Test Plan")
    ...
    def test_plan_type_unique_name(self):
        ...
        plan_type, created = PlanType.objects.get_or_create(
            name="free", defaults={"display_name": "Free Plan"}
        )

        with pytest.raises(Exception):  # IntegrityError or ValidationError
            PlanType.objects.create(name="free", display_name="Another Free Plan")
...
class TestUserPlanModel:
    ...
    def test_create_user_plan(self):
        ...
        plan_type, _ = PlanType.objects.get_or_create(
            name="test_basic",
            defaults={"display_name": "Test Basic Plan", "asset_limit": 10},
        )

        user_plan = UserPlan.objects.create(
            user=user, plan_type=plan_type, is_active=True, auto_renew=True
        )
    ...
    def test_user_plan_defaults(self):
        ...
        user_plan = UserPlan.objects.create(user=user, plan_type=plan_type)
    ...
    def test_user_plan_expired(self):
        ...
        plan_type, created = PlanType.objects.get_or_create(
            name="basic", defaults={"display_name": "Basic Plan"}
        )
        ...
        user_plan_future = UserPlan.objects.create(
            user=user, plan_type=plan_type, expires_at=future_date
        )
    ...
    def test_user_plan_can_use_feature(self):
        ...
        user_plan = UserPlan.objects.create(
            user=user, plan_type=plan_type, assets_used=5
        )
    ...
    def test_user_plan_get_remaining_assets(self):
        ...
        user_plan = UserPlan.objects.create(
            user=user, plan_type=plan_type, assets_used=4
        )
    ...
    def test_user_plan_unlimited_assets(self):
        ...
        user_plan = UserPlan.objects.create(
            user=user, plan_type=plan_type, assets_used=100
        )
...
class TestUserPlanMethods:
    ...
    def test_user_current_plan_property(self):
        ...
        user_plan = UserPlan.objects.create(
            user=user, plan_type=plan_type, is_active=True
        )
    ...
    def test_user_get_asset_limit(self):
        ...
        UserPlan.objects.create(user=user, plan_type=plan_type, is_active=True)
    ...
    def test_user_multiple_plans_only_active_matters(self):
        ...
        plan_type_inactive, created = PlanType.objects.get_or_create(
            name="free", defaults={"display_name": "Free Plan", "asset_limit": 1}
        )

        UserPlan.objects.create(
            user=user, plan_type=plan_type_inactive, is_active=False
        )

        # Create active plan
        plan_type_active, created = PlanType.objects.get_or_create(
            name="basic", defaults={"display_name": "Basic Plan", "asset_limit": 10}
        )

        UserPlan.objects.create(user=user, plan_type=plan_type_active, is_active=True)
