...
class TestPlanService:
    ...
    def test_assign_default_plan_existing_plan(self):
        ...
        UserPlan.objects.create(user=user, plan_type=existing_plan, is_active=True)
    ...
    def test_validate_asset_creation_success(self):
        ...
        plan_type, created = PlanType.objects.get_or_create(
            name="test_basic_25",
            defaults={"display_name": "Basic Plan", "asset_limit": 10},
        )
    ...
    def test_update_asset_usage(self):
        ...
        user_plan = UserPlan.objects.create(
            user=user, plan_type=plan_type, is_active=True, assets_used=5
        )
    ...
    def test_upgrade_user_plan(self):
        ...
        # Assign free plan
        UserPlan.objects.create(user=user, plan_type=free_plan, is_active=True)
    ...
    def test_upgrade_user_plan_same_plan(self):
        ...
        # Assign basic plan
        UserPlan.objects.create(user=user, plan_type=basic_plan, is_active=True)
    ...
    def test_plan_info_with_expired_plan(self):
        ...
        user_plan = UserPlan.objects.create(
            user=user, plan_type=plan_type, is_active=True, expires_at=expired_date
        )
