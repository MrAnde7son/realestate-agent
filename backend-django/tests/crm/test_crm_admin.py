...
class CrmAdminTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_superuser(
            email="crm_admin@example.com", username="crm_admin", password="testpass123"
        )
    ...
    def test_contact_admin_filtering(self):
        ...
        Contact.objects.create(
            owner=other_user, name="דוד לוי", email="david@example.com"
        )
    ...
    def test_lead_admin_filtering(self):
        ...
        Lead.objects.create(contact=contact, asset=asset2, status="contacted")
