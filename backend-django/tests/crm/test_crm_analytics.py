...
class CrmAnalyticsTests(TestCase):
    ...
    @patch("crm.models.track_contact_created")
    def test_contact_created_event_tracking_no_email_phone(
        self, mock_track_contact_created
    ):
        """Test contact created event tracking without email and phone"""
        data = {"name": "רות כהן", "tags": ["VIP"]}
    ...
    def test_asset_change_notified_event_tracking(
        self, mock_track_asset_change_notified
    ):
    ...
    def test_analytics_event_structure(self):
        ...
        with patch("crm.models.track_contact_created") as mock_track_contact_created:
            # Create contact
            data = {"name": "רות כהן", "email": "rut@example.com", "tags": ["VIP"]}
    ...
    def test_analytics_error_handling(self):
        ...
        with patch(
            "crm.models.track_contact_created", side_effect=Exception("Analytics error")
        ):
