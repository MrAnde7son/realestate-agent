...
class CrmSerializersTests(TestCase):
    ...
    def test_contact_serializer_validation(self):
        ...
        # Test invalid email
        data = {"name": "רות כהן", "email": "invalid-email", "phone": "050-1234567"}
        ...
        data = {"email": "rut@example.com", "phone": "050-1234567"}
    ...
    def test_contact_task_serializer_enforces_contact_ownership(self):
        ...
        owned_contact = Contact.objects.create(
            owner=self.user, name="Owned Contact", email="owned@example.com"
        )
        other_contact = Contact.objects.create(
            owner=self.other_user, name="Other Contact", email="other@example.com"
        )
    ...
    def test_contact_task_serializer_with_lead(self):
        ...
        contact = Contact.objects.create(
            owner=self.user, name="Test Contact", email="test@example.com"
        )
    ...
    def test_contact_serializer_empty_tags(self):
        ...
        data = {"name": "רות כהן", "email": "rut@example.com", "tags": []}
    ...
    def test_lead_serializer_serialization(self):
        ...
        self.assertEqual(
            data["notes"], [{"ts": "2024-01-01T12:00:00Z", "text": "Test note"}]
        )
    ...
    def test_lead_serializer_update(self):
        ...
        self.assertEqual(
            updated_lead.notes, [{"ts": "2024-01-01T12:00:00Z", "text": "Updated note"}]
        )
