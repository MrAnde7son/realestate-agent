...
class CrmSmokeTests(TestCase):
    ...
    def test_lead_creation_invalid_contact(self):
        ...
        data = {"contact_id_write": other_contact.id, "asset_id": self.asset.id}
    ...
    def test_contact_unique_email_per_owner(self):
        ...
        data1 = {"name": "רות כהן", "email": "rut@example.com"}
        ...
        data2 = {"name": "רות כהן אחרת", "email": "rut@example.com"}
        ...
        self.client.force_authenticate(user=self.other_user)
        data3 = {"name": "רות כהן אחרת", "email": "rut@example.com"}
