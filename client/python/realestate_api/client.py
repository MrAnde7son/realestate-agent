...
class RealEstateAPIClient:
    ...
    def __init__(
        self, base_url: str = "http://localhost:8000/api", token: Optional[str] = None
    ):
        """
    ...
    def register(
        self, email: str, password: str, username: str, **kwargs
    ) -> Dict[str, Any]:
        """
        Register a new user.
        ...
        """
        data = {"email": email, "password": password, "username": username, **kwargs}
