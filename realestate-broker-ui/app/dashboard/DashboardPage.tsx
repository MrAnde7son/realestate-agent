...
const DashboardCharts = dynamic(
  () => import("@/components/DashboardCharts"),
  {
    ...
    loading: () => (
      <Card>
        <CardHeader>
          <CardTitle>טוען תרשימים...</CardTitle>
        </CardHeader>
        <CardContent>
...
// Prefetch charts on hover for better perceived performance
let chartsPrefetched = false;
const prefetchCharts = () => {
  if (!chartsPrefetched && typeof window !== 'undefined') {
  ...
  return (
    <DashboardLayout>
      <DashboardShell>
        ...
        {/* Charts - dynamically loaded with prefetch on hover */}
        <div
          onMouseEnter={prefetchCharts}
          onTouchStart={prefetchCharts}
        >
          <DashboardCharts
            marketData={displayData.marketData || []}
            topAreas={displayData.topAreas || []}
            propertyTypes={displayData.propertyTypes || []}
