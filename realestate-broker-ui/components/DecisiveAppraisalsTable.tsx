...
interface DecisiveAppraisalsTableProps {
  data: DecisiveAppraisalRow[];
  loading?: boolean;
  searchValue?: string;
...
function createColumns(): ColumnDef<DecisiveAppraisalRow>[] {
  return [
    {
...
export default function DecisiveAppraisalsTable({
  data,
  loading = false,
  searchValue = '',
  onSearchChange,
