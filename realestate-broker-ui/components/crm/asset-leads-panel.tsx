...
import { LeadTaskSummary } from './lead-task-summary';
              ...
              <div>
                ...
                <div className="space-y-2">
                  {leads
                    ...
                    .slice(0, 3)
                    .map((lead) => (
                      <div key={lead.id} className="bg-gray-50 p-2 sm:p-3 rounded-lg">
                        <div className="flex justify-between items-start mb-1 rtl:flex-row-reverse">
                          <div className="font-medium text-xs sm:text-sm">{lead.contact.name}</div>
                          <LeadStatusBadge status={lead.status} />
                        </div>
