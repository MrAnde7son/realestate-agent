...
class TestUserPlanAssignments:
    ...
    def test_demo_user_has_basic_plan(self):
        """Test that demo@example.com has basic plan"""
        try:
            ...
            # Check that it's the basic plan
            assert demo_user.current_plan.plan_type.name == 'basic'
            assert demo_user.current_plan.plan_type.display_name == 'Basic Plan'
            
            # Check basic plan features
            plan_type = demo_user.current_plan.plan_type
            assert plan_type.asset_limit == 25
    ...
    def test_demo_user_plan_limits(self):
        ...
        try:
            ...
            # Test asset limits
            assert demo_user.get_asset_limit() == 25
    ...
    def test_plan_assignments_have_correct_pricing(self):
        ...
        try:
            ...
            # Check demo plan pricing
            demo_plan = demo_user.current_plan.plan_type
            assert demo_plan.price == Decimal('149.00')
    ...
    def test_plan_assignments_usage_tracking(self):
        ...
        try:
            ...
            assert demo_user.current_plan.get_remaining_assets() == 25
