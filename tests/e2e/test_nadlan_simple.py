...
TEST_LOCATION = LocationQuery(
    street="רוזוב", house_number=14, city="תל אביב", block=6336, parcel=7
)
...
class TestNadlanSimple:
    ...
    def test_deal_model_conversion(self):
        ...
        assert deal_dict["address"] == "רוזוב 14, תל אביב-יפו", (
    ...
    def test_gov_collector_initialization(self):
        ...
        assert collector.validate_parameters(location=TEST_LOCATION) is True, (
    ...
    def test_deal_model_edge_cases(self):
        ...
        # Test 3: Partial data
        partial_data = {"address": "רוזוב 14, תל אביב-יפו", "deal_amount": 2500000}

        partial_deal = Deal.from_item(partial_data)
        assert partial_deal.address == "רוזוב 14, תל אביב-יפו", (
    ...
    def test_transaction_data_validation(self):
        ...
        assert isinstance(deal_dict["deal_amount"], (int, float)), (
            "Deal amount should be numeric"
        )
