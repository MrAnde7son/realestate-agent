...
class TestDealRecord:
    ...
    def test_to_dict(self):
        ...
        deal = Deal(address="רחוב הרצל 1, תל אביב", deal_amount=1500000.0, rooms="3")
...
class TestNadlanDealsScraper:
    ...
    def test_get_deals_by_address_success(self, mock_get_deals):
        ...
        # Mock the deals
        mock_deals = [Deal(address="רחוב הרצל 1", deal_amount=1500000.0)]
    ...
    def test_error_modal_caching_protection(self):
        ...
        with (
            patch.object(scraper, "_init_driver"),
            ...
            mock_cache.store_deals.assert_called_once_with(
                'ק"ם 3 תל אביב-יפו', [], True
            )
    ...
    def test_successful_results_caching(self):
        ...
        with (
            patch.object(scraper, "_init_driver"),
            patch.object(
                scraper, "_fetch_deals_by_address_selenium", return_value=mock_deals
            ),
        ):
