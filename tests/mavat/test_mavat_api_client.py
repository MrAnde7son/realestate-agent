...
class TestMavatAPIClient:
    ...
    def test_api_client_initialization(self, mock_requests_session):
        ...
        assert (
            client.LOOKUP_URL
            == "https://mavat.iplan.gov.il/rest/api/Luts/4-5-6-7-8-9-10-11-39-48-52-53"
        )
    ...
    def test_search_lookup_by_text_specific_table(
        self, api_client, sample_lookup_response
    ):
    ...
    def test_search_lookup_by_text_case_insensitive(
        self, api_client, sample_lookup_response
    ):
    ...
    def test_search_plans_with_location(self, api_client, sample_search_response):
        ...
        results = api_client.search_plans(
            city="תל-אביב", district="תל-אביב", street="הירקון", limit=5
        )
    ...
    def test_search_plans_with_block_parcel(self, api_client, sample_search_response):
        ...
        results = api_client.search_plans(
            block_number="666", parcel_number="1", limit=10
        )
    ...
    def test_get_plan_attachments_with_special_characters(self, api_client):
        ...
        attachments = api_client.get_plan_attachments(
            "12345", "תוכנית עם תווים מיוחדים"
        )
