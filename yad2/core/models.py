...
class RealEstateListing:
    ...
    def contact_info(self, value: Any) -> None:
        ...
        if getattr(self, "contact_phone", None) is None:
            self.contact_phone = contact_dict.get("phone") or contact_dict.get(
                "brokerPhone"
            )
    ...
    def to_dict(self):
        ...
        return {
            ...
            "recent_deal": bool(self.recent_deal)
            if self.recent_deal is not None
            else False,
...
class Contact:
    def __init__(self, **kwargs):
        ...
        self.isVirtualPhoneNumber: bool = _get(
            "is_virtual_phone_number", "isVirtualPhoneNumber"
        )
    ...
    def __str__(self):
        return "Contact(name='{}', phone={})".format(
            self.name or "N/A", self.phone or "N/A"
        )
