...
class PropertyTypeUtils:
    ...
    def search_hebrew_name_to_code(search_term):
        ...
        for hebrew_name, code in hebrew_to_code.items():
            if (
                search_term_lower in hebrew_name.lower()
                or hebrew_name.lower() in search_term_lower
            ):
                ...
                writer.writerow(
                    {
                        ...
                        "name_english": PropertyTypeUtils.translate_to_english(
                            hebrew_name
                        ),
                ...
                data.append(
                    {
                        ...
                        "Name (English)": PropertyTypeUtils.translate_to_english(
                            hebrew_name
                        ),
                        "Category": PropertyTypeUtils.categorize_property_type(code),
                        "Description": PropertyTypeUtils.get_description(code),
                        "Aliases": ", ".join(
                            PropertyTypeUtils.get_aliases().get(hebrew_name, [])
                        ),
                    }
                )
    ...
    def get_correct_property_codes():
        ...
        return {
            ...
            "דירה עם גינה": {
                "code": 3,
                "english": "Apartment with Garden",
                "description": "דירה עם גינה",
            },
            ...
            "בית פרטי": {
                ...
                "description": "בית פרטי - בית חד משפחתי",
            },
            "בית": {
                "code": 39,
                "english": "Single-family house",
                "description": "בית - בית חד משפחתי",
            },
            ...
            "דירה עתידית": {
                "code": 50,
                "english": "Future apartment",
                "description": "דירה עתידית",
            },
            "דירת גן": {
                "code": 3,
            ...
            "מיני פנטהאוס": {
                "code": 37,
                "english": "Mini Penthouse",
                "description": "מיני פנטהאוס",
            },
            ...
            "דירת נופש": {
                ...
                "description": "דירת נופש",
            },
            "בית מלון": {"code": 25, "english": "Hotel", "description": "בית מלון"},
            "חצר": {"code": 52, "english": "Farm", "description": "חצר/משק"},
            "משק חקלאי": {
                "code": 32,
                "english": "Agricultural farm",
                "description": "משק חקלאי",
            },
            "בית בטוח": {
                "code": 61,
                "english": "Safe house",
                "description": 'בית בטוח/ממ"ד',
            },
            'ממ"ד': {
                "code": 61,
                "english": "Safe house",
                "description": "מרחב מוגן דירתי",
            },
            "מרחב מוגן דירתי": {
                "code": 61,
                "english": "Safe house",
    ...
    def get_correct_neighborhood_codes():
        ...
        return {
            "רמת החייל": {
                "code": 203,
                "english": "Ramat HaHayal",
                "description": "שכונת רמת החייל בתל אביב",
            },
            "מרכז העיר": {
                "code": 199,
                "english": "City Center",
                "description": "מרכז העיר תל אביב",
            },
            "נווה צדק": {
                "code": 200,
                "english": "Neve Tzedek",
                "description": "שכונת נווה צדק",
            },
            "פלורנטין": {
                "code": 312,
                "english": "Florentin",
                "description": "שכונת פלורנטין",
            },
            "תל אביב": {
                "code": 5000,
                "english": "Tel Aviv",
                "description": "עיר תל אביב",
            },
            "ירושלים": {
                "code": 6200,
                "english": "Jerusalem",
                "description": "עיר ירושלים",
            },
    ...
    def print_correct_codes():
        ...
        for hebrew_name, info in property_codes.items():
            print(
                f"{hebrew_name:20} -> Code: {info['code']:2} | {info['english']:25} | {info['description']}"
            )
        ...
        for hebrew_name, info in neighborhood_codes.items():
            print(
                f"{hebrew_name:20} -> Code: {info['code']:4} | {info['english']:25} | {info['description']}"
            )
